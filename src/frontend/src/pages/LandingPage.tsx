    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F3F0E6" }}>
      ...
      <main>
        ...
        <section className="px-6 pb-20 max-w-5xl mx-auto">
          {/* Screenshot label above the mockup */}
          <div className="flex justify-end mb-2">
            <span
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold select-none"
              style={{
                backgroundColor: "rgba(111,157,121,0.15)",
                color: "#4A7A57",
                border: "1px solid rgba(111,157,121,0.35)",
              }}
            >
              <Camera className="h-3 w-3" />
              Screenshot Preview — Not Interactive
            </span>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {FOOTER_LEGAL.map((l) => (
                  <li key={l}>
                    {l === "Terms of Service" && onTerms ? (
                      <button
                        type="button"
                        onClick={onTerms}
                        className="hover:opacity-80 transition-opacity bg-transparent border-0 p-0 cursor-pointer"
                        style={{ color: "#9AB", font: "inherit" }}
                      >
                        {l}
                      </button>
                    ) : (
